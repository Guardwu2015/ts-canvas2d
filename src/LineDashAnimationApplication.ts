import { Canvas2DApplication, Application, TimerCallback, CanvasMouseEvent, CanvasKeyBoardEvent } from "./utils/application"
import { Math2D, mat2d, MatrixStack, Size, vec2, Rectangle, Inset } from "./utils/math2d";
class RenderState {
...
class TestApplication extends Canvas2DApplication {
    ...
    /*******************************************4.1节代码************************************************ */
    public drawRect ( x: number, y: number, w: number, h: number , isDash:boolean = false): void {
        if ( this.context2D !== null ) {
